"""
Test script for warp_bitonic_sort via TVM FFI.

Run from the tvmffi/ directory:
    python test/test.py
"""
import sys
import os

# Add parent dir so we can import warp_bitonic_sort package
...
print("=" * 50)
print("Test warp_bitonic_sort (TVM FFI + PyTorch DLPack)")
print("=" * 50)
