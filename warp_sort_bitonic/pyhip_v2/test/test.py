"""
Test script for warp_bitonic_sort via Python-side hipLaunchKernel (no <<<>>> in C++).

Run from the pyhip_v2/ directory:
    python test/test.py
"""
import sys
import os
...
print("=" * 60)
print("Test warp_bitonic_sort (Python hipLaunchKernel, no <<<>>>)")
print("=" * 60)
