"""
Test script for warp_bitonic_sort via HIP driver API (--genco, no host code).

Run from the pyhip_v3/ directory:
    python test/test.py
"""
import sys
import os
...
print("=" * 60)
print("Test warp_bitonic_sort (hipModuleLaunchKernel, --genco)")
print("=" * 60)
