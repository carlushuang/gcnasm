// v83: unconditional rescale + hoisted V addresses + fused rescale-PV
...
#include "attn_gfx1201_kernel_v83_template.hpp"
...
int main(int argc, char** argv) {
    ...
    auto run = [&](auto traits_tag) {
        ...
        printf("running version v83-blockM%d  B=%d H=%d N=%d D=%d\n",Traits::BLOCK_M,B,H,N,D);
        auto kern = opus_attn_gfx1201_kernel_v83<Traits>;
