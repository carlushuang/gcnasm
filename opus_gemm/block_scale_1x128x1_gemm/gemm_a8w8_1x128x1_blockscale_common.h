...
template<
    ...
    int GROUP_N_ = 1,
    int GROUP_K_ = 128>
struct gemm_a8w8_1x128x1_blockscale_traits {
    ...
    static constexpr int E_N_SFB = HALF_B_N / (WARP_SIZE * T_N);
    ...
    static constexpr int sfb_buffer_load_insts = E_N_SFB * (B_K / GROUP_K);
};
