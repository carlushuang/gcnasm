...
Default traits (`gemm_a8w8_1x128x1_blockscale_traits<>`):
...
├── Makefile
├── rebuild.sh
├── gemm_a8w8_1x128x1_blockscale_common.h              # kargs + traits
├── gemm_a8w8_1x128x1_blockscale_kernel_template.hpp   # kernel body
├── gemm_a8w8_1x128x1_blockscale_kernel.cc             # device-only TU + host stub
└── gemm_a8w8_1x128x1_blockscale_host.cc               # host launcher / benchmark / CPU reference
```
...
```bash
./build/gemm_a8w8_1x128x1_blockscale.exe                         # defaults: b=8, m=256, n=512, k=256
./build/gemm_a8w8_1x128x1_blockscale.exe -b 1 -m 4096 -n 4096 -k 4096
./build/gemm_a8w8_1x128x1_blockscale.exe -b 1 -m 1024 -n 1024 -k 1024 -v 1   # validate vs CPU
```
