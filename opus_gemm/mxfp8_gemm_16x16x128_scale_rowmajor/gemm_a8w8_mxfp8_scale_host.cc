...
int main(int argc, char** argv) {
    ...
    // The GEMM reads the scales exactly as they come out of a quantizer:
    // SFA[batch][M][K/32] and SFB[batch][N][K/32], row-major, no preprocessing.
    ...
    // The kernel reads the scales in their logical row-major layout and builds
    // the consumer-major image itself, in registers, on the way into LDS.
