...
- kernel is `csrc/opus_fmm.hpp` and its header, they are torch independent. This could be `.hip` or `.cu` surfix, cause anyway the cpp_extension will hipify it. better not use `.cpp` cause [cpp_extension here](https://github.com/pytorch/pytorch/blob/1927783aa3ad676db6f4c34fc77ef3825a4e2ed5/torch/utils/cpp_extension.py#L750) will check the surfix and apply different compile flag.
